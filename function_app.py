...
# New Programming Model v2 entry
app = func.FunctionApp(http_auth_level=func.AuthLevel.FUNCTION)

# Root of the deployed app
...
@app.function_name(name="predict_team")
@app.route(route="predict_team", methods=["POST"])
def predict_team(req: func.HttpRequest) -> func.HttpResponse:
    try:
